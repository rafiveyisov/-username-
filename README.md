# Hi there, I'm Rafi Veyisov 👋

### 🚀 Machine Learning / AI Engineer | MSc in Computer Science
*Passionate about building scalable AI systems, specializing in RAG Pipelines, Deep Learning architectures, and LLM optimization.*
...
| :--- | :--- |
| **Languages** | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white) ![SQL](https://img.shields.io/badge/SQL-4479A1?style=flat&logo=postgresql&logoColor=white) ![C++](https://img.shields.io/badge/C++-00599C?style=flat&logo=c%2B%2B&logoColor=white) |
...
| **Deep Learning** | ![CNN](https://img.shields.io/badge/CNN-Architecture-blue) ![RNN/LSTM](https://img.shields.io/badge/RNN/LSTM-Sequential-orange) ![Transformers](https://img.shields.io/badge/Transformers-Attention-yellow) |
| **Tools** | ![CUDA](https://img.shields.io/badge/CUDA-76B900?style=flat&logo=nvidia&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white) ![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white) |
...
### ⚡ Current Focus
* 🔭 **Learning:** Advanced Vector Database optimization (HNSW/IVF) and Large Language Model (LLM) fine-tuning techniques (LoRA/QLoRA).
* 🌱 **Building:** An automated evaluation framework for RAG systems (RAGAS).
